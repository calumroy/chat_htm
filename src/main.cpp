...
using chat_htm::diagnostics::LayerMetrics;
...
int main(int argc, char* argv[]) {
  ...
  pre_override_metrics.print(std::cout, "Pre-override metrics", measured_layer);
  post_override_metrics.print(std::cout, "Post-override metrics", measured_layer);
